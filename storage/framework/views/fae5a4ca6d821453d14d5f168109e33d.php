...
<body>
    <div id="layout-wrapper">
            ...
            <div class="layout-width">
                <div class="navbar-header d-flex justify-content-between align-items-center px-3">
                    <a href="/" class="d-flex align-items-center gap-2 text-white text-decoration-none">
                        <img src="<?php echo e(asset('images/logo-light.png')); ?>" height="24" alt="Logo">
        ...
        <?php echo $__env->make('layouts.sidebar-public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/resources/views/layouts/frontend-minimal.blade.php ENDPATH**/ ?>