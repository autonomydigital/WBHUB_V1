                ...
                <div class="col-xxl-3 col-lg-3 col-md-6">
                    <div class="card team-box">
                        ...
                        <div class="team-cover">
                            <img src="<?php echo e(asset('storage/' . $user->cover_photo)); ?>" class="img-fluid" alt="cover" />
                                                </div>
                            ...
                            <div class="row align-items-center team-row">
                                ...
                                <div class="col-lg-4 col">
                                    <div class="team-profile-img">
                                        <div class="avatar-lg">
                                            <img src="<?php if($user->avatar): ?> <?php echo e(asset('storage/' . $user->avatar)); ?> <?php else: ?> <?php echo e(asset('build/images/users/user-dummy-img.jpg')); ?> <?php endif; ?>"
                                                alt="avatar"
                                        ...
                                        <div class="team-content">
                                            <a class="member-name" data-bs-toggle="offcanvas" href="#member-overview" aria-controls="member-overview">
                                                <h5 class="fs-16 mb-1"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h5>
                                            </a>
                                            <p class="text-muted member-designation mb-0"><?php echo e($user->designation ?? 'Member'); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col">
                                    <div class="text-end">
                                        <a href="<?php echo e(route('users.profile', $user->id)); ?>" class="btn btn-light view-btn">View Profile</a>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/resources/views/users_old.blade.php ENDPATH**/ ?>