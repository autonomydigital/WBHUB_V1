                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                ...
                                <p>Please enter the 4‑digit code sent to <span class="fw-semibold"><?php echo e(auth()->user()->email); ?></span></p>
                            </div>
                            ...
                            <form id="verify-form" method="POST" action="<?php echo e(route('verification.verify')); ?>">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <?php for($i = 1; $i <= 4; $i++): ?>
                                        <div class="col-3 mb-3">
                                            <input type="text"
                                                   ...
                                                   maxlength="1"
                                                   id="digit<?php echo e($i); ?>-input"
                                                   onkeyup="moveToNext(this, <?php echo e($i+1); ?>)"
                                                   required>
                                        </div>
                                    <?php endfor; ?>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/resources/views/auth/verify.blade.php ENDPATH**/ ?>