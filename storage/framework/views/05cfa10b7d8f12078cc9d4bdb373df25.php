...
<?php $__env->startSection('title'); ?> Nyrix AI <?php $__env->stopSection(); ?>
...
<div class="row" data-masonry='{"percentPosition": true }'>
    ...
    z-index: -1;
">
    <source src="<?php echo e(asset('videos/nyrix-bg.mp4')); ?>" type="video/mp4">
</video>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center border-0 bg-transparent">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center p-3" style="backdrop-filter: blur(6px); background-color: rgba(0,0,0,0.3); border-radius: 1rem;">
                            <img src="<?php echo e(asset('images/nyrix-logo.png')); ?>" alt="Nyrix Logo" class="img-fluid">
                        </div>
                    </div>
                </div>
      ...
      <button id="disable-nyrix-button" class="btn btn-danger mt-2" style="display: none;">🛑 Disable Nyrix</button>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="<?php echo e(route('nyrix.toggle')); ?>" class="btn btn-outline-warning w-100 mb-2">
                                🔁 Toggle Nyrix
                            </a>
                            <form method="POST" action="<?php echo e(route('nyrix.toggle')); ?>">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="enabled" value="<?php echo e(config('nyrix.enabled') ? '' : '1'); ?>">
                                <button type="submit" class="btn btn-outline-<?php echo e(config('nyrix.enabled') ? 'danger' : 'success'); ?> w-100">
                                    <?php echo e(config('nyrix.enabled') ? 'Disable Nyrix' : 'Enable Nyrix'); ?>
            ...
            <div class="card-body">
                <?php if(session('response')): ?>
                    <div class="alert alert-secondary">
                        <strong>Nyrix:</strong> <?php echo e(session('response')); ?>
                ...
                <div class="alert alert-secondary">
                    💬 <strong>Nyrix:</strong> <?php echo e(session('message')); ?>

                </div>
            <?php endif; ?>
            
            <?php if(session('ai_command')): ?>
                <div class="alert alert-info">
                    <strong>🧠 Suggested Command:</strong><br>
                    <code><?php echo e(session('ai_command')); ?></code><br>
                    <small><?php echo e(session('explanation')); ?></small><br>
                    <button class="btn btn-sm btn-outline-primary mt-2"
                        onclick="runCommand(<?php echo \Illuminate\Support\Js::from(session('ai_command'))->toHtml() ?>)">Run this command</button>
                </div>
            <?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('nyrix.ask')); ?>" id="ask-nyrix-form">                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<script>
window.nyrixExecuteUrl = window.nyrixExecuteUrl || "<?php echo e(route('nyrix.execute')); ?>";
...
<script src="<?php echo e(asset('js/modules/nyrix/nyrix-voice.js')); ?>"></script>
<script src="<?php echo e(asset('js/modules/nyrix/nyrix-tracker.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/Modules/Nyrix/Views/index.blade.php ENDPATH**/ ?>