                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                <h5 class="text-primary">It's good to have you back</h5>
                                <p class="text-muted">Sign in to continue to the Hub</p>
                            </div>
                            <div class="p-2 mt-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', 'overlord@wbhub.au')); ?>" id="username" name="email" placeholder="Enter username">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Don't have an account yet? <a href="<?php echo e(route('register')); ?>" class="fw-semibold text-primary text-decoration-underline"> Sign up </a> </p>
                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/resources/views/auth/login.blade.php ENDPATH**/ ?>