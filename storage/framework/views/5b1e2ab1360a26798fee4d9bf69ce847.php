        ...
        <div class="col-12 col-lg-auto order-last order-lg-0">
            <div class="row text text-white-50 text-center">
                <div class="col-lg-6 col-4">
                    <div class="p-2">
                        <h4 class="text-white mb-1"><?php echo e($user->followers ?? '0'); ?></h4>
                        <p class="fs-14 mb-0">Followers</p>
                    </div>
                </div>
                <div class="col-lg-6 col-4">
                    <div class="p-2">
                        <h4 class="text-white mb-1"><?php echo e($user->following ?? '0'); ?></h4>
...
<div class="row">
    <div class="col-lg-12">
        <div class="d-flex profile-wrapper">
            ...
            <!-- Edit Button (only for self or superadmin) -->
            <?php if(auth()->id() === $user->id || auth()->user()?->hasRole('superadmin')): ?>
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted"><?php echo e($user->phone ?? 'Not provided'); ?></td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="col-xxl-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p>In the labyrinthine corridors of our digital empire, I reign supreme as the Overlord Administrator, wielding the scepter of innovation and the sword of strategic prowess. With every keystroke, I command our digital legions to conquer new territories and expand our dominion across the vast expanse of cyberspace. My resolve is unwavering, my vision unyielding, as I lead our empire into battle against the forces of stagnation and mediocrity.
                                        </p><p>
                                            Under my visionary guidance, we forge alliances, harnessing the power of innovation to shape the destiny of our digital realm. Together, we march forward, conquering new frontiers and laying siege to the barriers that stand in our path. As the Overlord Administrator, I stand as a beacon of strength and determination, guiding our empire towards a future where our triumphs echo through the annals of history, and our legacy is etched in the code of the digital age.</p>
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <a href="#" class="fw-semibold">http://wbhub.au</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/resources/views/pages-profile.blade.php ENDPATH**/ ?>