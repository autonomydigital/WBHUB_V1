...
<form method="POST"
action="<?php echo e(route('profile.cover.update', $user->id)); ?>"
...
<div class="position-relative mx-n4 mt-n4">
  <div class="profile-wid-bg profile-setting-img">
    ...
    src="<?php echo e($user->cover_photo ? asset('storage/' . $user->cover_photo) : asset('build/images/profile-bg.jpg')); ?>"
...
<div class="modal fade" id="chooseCoverModal" tabindex="-1" aria-labelledby="chooseCoverModalLabel" aria-hidden="true">
    ...
    <div class="card mt-n5">
            ...
            <div class="text-center">
                <div class="profile-user position-relative d-inline-block mx-auto mb-4">
                    <img id="user-avatar-img"
                         src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : asset('build/images/users/avatar-1.jpg')); ?>"
                ...
                <h5 class="fs-17 mb-1"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?> </h5>
            ...
            <div class="card-body">
                ...
                <div class="progress animated-progress custom-progress progress-label">
                    <div id="profile-progress-bar"
                         class="progress-bar <?php echo e($barClass); ?>"
                         role="progressbar"
                         style="width: <?php echo e($completion); ?>%"
                         aria-valuenow="<?php echo e($completion); ?>"
                         aria-valuemin="0"
                         aria-valuemax="100">
                        <div class="label" id="profile-progress-label"><?php echo e($completion); ?>%</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form id="socialsForm" method="POST" action="<?php echo e(route('profile.socials.update', $user->id)); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="flex-shrink-0 position-relative">
                            <a href="javascript:void(0);" id="socialAddButton" class="badge bg-light text-primary fs-12" data-bs-toggle="modal" data-bs-target="#chooseSocialModal">
                                <i class="ri-add-fill align-bottom me-1"></i> Add
                            </a>
        
                            <!-- Popover -->
                           <!-- Choose Social Modal -->
<div class="modal fade" id="chooseSocialModal" tabindex="-1" aria-hidden="true">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <?php $__currentLoopData = $platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center" style="width: 72px;">
                            <button type="button"
                                    class="border-0 bg-transparent p-0 mb-1"
                                    onclick="addSocialInput('<?php echo e($platform['name']); ?>', '<?php echo e($platform['icon']); ?>', '<?php echo e($platform['color']); ?>'); hideChooseSocialModal();">
                                <span class="avatar-title rounded-circle d-inline-flex justify-content-center align-items-center <?php echo e($platform['color']); ?> text-white fs-4"
                                      style="width: 48px; height: 48px;">
                                    <i class="<?php echo e($platform['icon']); ?>"></i>
                                </span>
                            </button>
                            <div class="small text-muted"><?php echo e($platform['name']); ?></div>
                        </div>
                            ...
                            <?php $__currentLoopData = $user->socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-3 d-flex align-items-center social-input-row">
                                    <div class="avatar-xs d-block flex-shrink-0 me-3">
                                        <span class="avatar-title rounded-circle fs-4 <?php echo e($social->color ?? 'bg-secondary'); ?>">
                                            <i class="<?php echo e($social->icon ?? 'ri-global-fill'); ?> text-white"></i>
                                        </span>
                                    </div>
                                    <input type="hidden" name="socials[<?php echo e($social->platform); ?>][platform]" value="<?php echo e($social->platform); ?>">
                                    <input type="hidden" name="socials[<?php echo e($social->platform); ?>][color]" value="<?php echo e($social->color); ?>">
                                    <input type="hidden" name="socials[<?php echo e($social->platform); ?>][icon]" value="<?php echo e($social->icon); ?>">
                                    <input type="text" class="form-control me-2" name="socials[<?php echo e($social->platform); ?>][handle]"
                                    value="<?php echo e($social->handle); ?>" placeholder="<?php echo e(ucfirst($social->platform)); ?> handle">
                                <div class="invalid-feedback">
                                    Please enter your <?php echo e(ucfirst($social->platform)); ?> handle.
                                </div>        
                                    
                                    <button
                                    type="button"
                                    class="btn btn-sm btn-icon btn-light"
                                    onclick="deleteSocial(this, '<?php echo e($social->platform); ?>')">
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                            <div class="card bg-body border-dark border-4  shadow-sm mb-4">
                                <div class="card-body">
                                    <div class="d-flex position-relative align-items-center">
                                        <img src="<?php echo e(asset('images/details-icon.jpg')); ?>" class="flex-shrink-0 me-4 avatar-xl rounded" alt="Manage Details Icon">
                                        <div>
                            ...
                            <form id="profileUpdateForm" method="POST" action="<?php echo e(route('profile.update', $user->id)); ?>">                                <?php echo csrf_field(); ?>
                                <div class="row">
                            
                                    <!-- First Name -->
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="first_name" class="form-control" id="firstnameInput" placeholder="First Name" value="<?php echo e($user->first_name); ?>">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="last_name" class="form-control" id="lastnameInput" placeholder="Last Name" value="<?php echo e($user->last_name); ?>">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="phone" class="form-control" id="phonenumberInput" placeholder="Phone Number" value="<?php echo e($user->phone); ?>">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="email" name="email" class="form-control" id="emailInput" placeholder="Email Address" value="<?php echo e($user->email); ?>">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" name="bio" id="bioInput" placeholder="Enter your bio" style="height: 100px"><?php echo e($user->bio); ?></textarea>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="suburb" class="form-control" id="suburbInput" placeholder="Suburb" value="<?php echo e($user->suburb); ?>">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="state" class="form-control" id="stateInput" placeholder="State" value="<?php echo e($user->state); ?>">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" name="postcode" class="form-control" id="zipcodeInput" placeholder="Postcode" value="<?php echo e($user->postcode); ?>">
                        ...
                        <div class="tab-pane fade" id="changePassword" role="tabpanel">
                            <div class="card bg-body border-dark border-4  shadow-sm mb-4">
                                <div class="card-body">
                                    <div class="d-flex position-relative align-items-center">
                                        <img src="<?php echo e(asset('images/password-icon.jpg')); ?>" class="flex-shrink-0 me-4 avatar-xl rounded" alt="Security Icon">
                                        <div>
...
<!-- Change Password -->
<div class="col-lg-6">
    <form id="changePasswordForm" method="POST" action="<?php echo e(route('profile.password.update', $user->id)); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div class="border border-light-subtle rounded shadow-sm p-3 mb-4 h-100">
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="btn btn-sm  passwordButton btn-outline-secondary">Forgot Password?</a>
            </div>
            <hr class="mt-2 mb-3">
...
<!-- login history col -->
<div class="col-lg-6">
    <div class="border rounded shadow-sm p-3 d-flex flex-column h-100">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h5 class="fs-16 fw-semibold mb-0">Login History</h5>
        ...
        <!-- Scrollable area limited by max height -->
        <div id="loginHistoryScroll"
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light text-primary rounded-3 fs-2">
                                <i class="<?php echo e(Str::contains(strtolower($entry->device), 'mobile') ? 'ri-smartphone-line' : 'ri-macbook-line'); ?>"></i>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-0"><?php echo e($entry->device); ?></h6>
                            <p class="text-muted mb-0" style="font-size: 9pt;">
                                <?php echo e($entry->city && $entry->country ? "{$entry->city}, {$entry->country}" : 'Unknown location'); ?><br>
                                <?php echo e(\Carbon\Carbon::parse($entry->logged_in_at)->format('M d, Y \a\t h:i A')); ?>
            ...
            <?php endif; ?>
                        ...
                        <div class="tab-pane" id="privacy" role="tabpanel">
                            <div class="card bg-body border-dark border-4  shadow-sm mb-4">
                                <div class="card-body">
                                    <div class="d-flex position-relative align-items-center">
                                        <img src="<?php echo e(asset('images/privacy-icon.jpg')); ?>" class="flex-shrink-0 me-4 avatar-xl rounded" alt="Privacy Icon">
                                        <div>
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input security-toggle" type="checkbox"
                   ...
                   <?php echo e($user->two_factor_enabled ? 'checked' : ''); ?>>
        </div>
    </div>
    <hr class="mt-0 mb-2">
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="form-check form-switch">
            <input class="form-check-input security-toggle" type="checkbox"
                   ...
                   <?php echo e($user->secondary_verification ? 'checked' : ''); ?>>
        </div>
    </div>
    <hr class="mt-0 mb-2">
    <p class="text-muted pt-2 mb-0">
...
<div class="d-flex flex-column mb-4 p-3 border border-light-subtle rounded shadow-sm position-relative">
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <a href="javascript:void(0);" id="generateBackupCodesBtn" class="btn btn-sm btn-success">Generate Codes</a>
    </div>
    <hr class="mt-0 mb-2">
    <p class="text-muted pt-2 mb-2">
        Backup codes allow login when you're unable to access your 2FA device. Generate them and store them securely.
    </p>

    
    <?php if($user->backupCodes()->exists()): ?>
        <div id="existingBackupCodes" class="pt-2">
            <h6 class="text-body-secondary fs-13 mb-2">Your Current Backup Codes:</h6>
            <div class="bg-light border rounded p-3 small">
                <?php $__currentLoopData = $user->backupCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <code><?php echo e($code->code); ?></code> <?php echo $code->used ? '<small class="text-danger">(used)</small>' : ''; ?><br>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    <?php endif; ?>
    ...
    <div id="backupCodesContainer" class="pt-2" style="display: none;">
        <h6 class="text-body-secondary fs-13 mb-2">New Backup Codes:</h6>
        <div id="backupCodesList" class="bg-light border rounded p-3 small"></div>
    </div>
</div>                        
</div>      
                        ...
                        <div class="tab-pane fade" id="notifications" role="tabpanel" aria-labelledby="notifications-tab">
                            ...
                            $notifications = [
                                ['id' => 'directMessage', 'label' => 'Direct messages', 'desc' => 'Messages from people you follow.'],
                        ...
                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex flex-column flex-sm-row mb-4 p-3 border border-light-subtle rounded shadow-sm position-relative">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-1"><?php echo e($notif['label']); ?></h6>
                                    <p class="text-muted mb-0"><?php echo e($notif['desc']); ?></p>
                                </div>
                                <div class="flex-shrink-0 ms-sm-3 align-self-start">
                                    <div class="form-check form-switch">
                                        <input
                                            ...
                                            <?php echo e(($settings[$notif['id']] ?? false) ? 'checked' : ''); ?>
...
<script>
    window.validatePasswordUrl     = "<?php echo e(route('profile.password.validate')); ?>";
    window.defaultCoverUrl         = "<?php echo e(route('profile.cover.list')); ?>";
    window.chooseCoverUrl          = "<?php echo e(route('profile.cover.choose')); ?>";
    window.loginHistoryClearUrl    = "<?php echo e(route('profile.login-history.clear')); ?>";
    window.generateBackupCodeUrl = "<?php echo e(route('profile.backup.generate')); ?>";
    window.notificationToggleUrl = "<?php echo e(route('profile.notifications.toggle')); ?>";
    window.csrfToken = "<?php echo e(csrf_token()); ?>";

    
    // document.addEventListener('change', function (e) {
    //     if (e.target && e.target.classList.contains('notification-toggle')) {
    ...
    //     if (e.target && e.target.classList.contains('security-toggle')) {
    //         const toggle = e.target;
    //         const id = toggle.dataset.setting;
    //         const enabled = toggle.checked;
    
    //         fetch('/profile/security/toggle', {
    //             method: 'POST',
    //             headers: {
    //                 'X-CSRF-TOKEN': window.csrfToken,
    //                 'Content-Type': 'application/json'
    ...
    //     // Add similar blocks here for `privacy-toggle`, etc.
    // });

</script>
<script src="https://unpkg.com/@popperjs/core@2"></script>

<script src="<?php echo e(asset('js/modules/userprofiles/settings.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/luk/Desktop/WORKSPACE/WBHUB_V1/Modules/UserProfiles/resources/views/settings.blade.php ENDPATH**/ ?>