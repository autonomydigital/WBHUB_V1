        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'overlord@wbhub.au') }}" id="username" name="email" placeholder="Enter username">
                                        @error('email')
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Don't have an account yet? <a href="{{ route('register') }}" class="fw-semibold text-primary text-decoration-underline"> Sign up </a> </p>
                    </div>
