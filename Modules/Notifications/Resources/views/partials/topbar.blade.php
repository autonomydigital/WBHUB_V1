            ...
            <div class="px-2 pt-2">
                <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true" role="tablist">
                    <li class="nav-item waves-effect waves-light">
                        <a class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab" role="tab">All ({{ $unreadCount }})</a>
                    </li>
                    <li class="nav-item waves-effect waves-light">
            ...
            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                <div data-simplebar style="max-height: 300px;" class="pe-2">
                    ...
                    <div class="my-3 text-center view-all">
                        <a href="{{ route('notifications.alerts') }}" class="btn btn-soft-success waves-effect waves-light">
                                ...
                                <div class="avatar-xs me-3 flex-shrink-0">
                                    ...
                                    @else
                                        <span class="avatar-title bg-warning-subtle text-warning rounded-circle fs-16">
                                            <i class="{{ $data['icon'] ?? 'bx bx-user-plus' }}"></i>
                                        </span>
                                    @endif
                                </div>
