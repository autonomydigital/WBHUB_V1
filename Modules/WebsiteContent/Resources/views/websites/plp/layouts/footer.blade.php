...
<!-- Main Footer Blade Partial -->
           ...
           @include('websitecontent::websites.plp.partials.wishlist')

           @include('websitecontent::websites.plp.partials.register-form')

           @include('websitecontent::websites.plp.partials.progress-bar')

           @include('websitecontent::websites.plp.partials.map-modal')
...
<!-- JS Files -->
<!-- JS Files -->
<script src="{{ url('/business-sites/plp/js/jquery.min.js') }}"></script>
<script src="{{ url('/business-sites/plp/js/plugins.js') }}"></script>
<script src="{{ url('/business-sites/plp/js/scripts.js') }}"></script>

<script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAPS_API_KEY') }}&libraries=places&callback=initMap" async defer></script>

<script src="{{ url('/business-sites/plp/js/map-single.js') }}"></script>
</body>
</html>