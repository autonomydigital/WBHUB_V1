                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="hero-section-title hs_align-title">
                                <div class="hero-section-title_sub">Welcome to Peter Lawton Property</div>
                                <h2>Friendly and Hassle-free<br>Property Services in Bowen</h2>
                                <div class="slider-caption">Looking to buy or sell in Bowen? We’re all about making the process smooth, stress-free, and even enjoyable!<br>With a friendly, down-to-earth approach, we take the hassle out of real estate so you can focus on what matters most.</div>
                                <a href="#sec1" class="commentssubmit csb_color  custom-scroll-link" style="margin-top: 40px">Looking to Sell</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="ms-item_fs full-height fl-wrap">
                                    <div class="bg" data-bg="{{ url('/business-sites/plp/images/bg/1.jpg') }}"></div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms-item_fs full-height fl-wrap">
                                    <div class="bg" data-bg="{{ url('/business-sites/plp/images/bg/2.jpg') }}"></div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="ms-item_fs full-height fl-wrap">
                                    <div class="bg" data-bg="{{ url('/business-sites/plp/images/bg/3.jpg') }}"></div>
                                </div>
                            </div>                                           
                        </div>
                    </div>
