                        ...
                        <div class="hidden-listing-filter">
                            ...
                            <div class="hidden-listing-item">
                                ...
                                <ul class="filter-tags no-list-style">
                                    @foreach(['Elevator', 'Laundry Room', 'Kitchen', 'Air Conditioning', 'Parking', 'Pool', 'Gym', 'Security', 'Garage', 'Yard', 'Fireplace'] as $amenity)
                                        <li>
                                            <input type="checkbox" id="amenity-{{ Str::slug($amenity) }}" name="amenities[]" value="{{ $amenity }}">
                                            <label for="amenity-{{ Str::slug($amenity) }}">{{ $amenity }}</label>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
